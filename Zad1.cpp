...

{
	...
	GLboolean error = load_targa("abc.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku man_black_skin_face_20141210_1355641774.tga");
	...
	error = load_targa("abc.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku man_black_skin_face_20141210_1355641774.tga.tga");
...

{
	...
	glutAddMenuEntry("abc.tga (kompresja)", TEXTURE_LENA);

	glutAddMenuEntry("abc.tga (bez kompresji)", TEXTURE_LENA_UNC);

	glutAddMenuEntry("abc.tgaa (kompresja)", TEXTURE_LENA_GRAY);

	glutAddMenuEntry("abc.tga (bez kompresji)", TEXTURE_LENA_GRAY_UNC);
